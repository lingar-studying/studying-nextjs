...
const WorkdaysIsraelJourney = (props) => {
    ...
    useEffect(() => {
        if (notWorkingDays && notWorkingDays.length > 0) {
    ...
    return (<>
        <Box component="div">
            ...
            <Box>
                ...
                Content generated by the Hebcal.com web APIs is licensed under a Creative Commons Attribution 4.0
                International License. This means that you can use you are free to copy and redistribute the material in
                any medium or format as long as you give appropriate credit to Hebcal.com.
            </Box>
